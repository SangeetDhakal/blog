        ...
        if (router.query.slug) {
            singleBlog(router.query.slug).then(data => {
                if (data.error) {
                    ...
                    setValues({ ...values, title: data.title, mdesc: data.mdesc, excerpt: data.excerpt});
        ...
        return (
            <form onSubmit={editBlog}>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" value={mdesc} onChange={handleChange('mdesc')} />
                </div>

                <div className="form-group">
                    <label className="text-muted">Excerpt</label>
                ...
                <div className="col-md-4">
                    <div>
                        <div className="form-group pb-2">
                            ...
                            {body && (
                        <img src={`${API}/blog/photo/${router.query.slug}`} alt={title} style={{ width: '60%' }} />
                    )}
                        </div>
                    </div>
                    <div>
