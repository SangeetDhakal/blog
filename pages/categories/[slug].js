...
const Category = ({ category, blogs, query, totalBlogs,blogsLimit, blogSkip, }) => {
    ...
    const head = () => (
        <Head>
            ...
            <meta name="description" content={`${category.name} related to upcoming celebrities.`} />
            <link rel="canonical" href={`${DOMAIN}/categories/${query.slug}`} />
            <meta property="og:title" content={`${category.name}| ${APP_NAME}`} />
            <meta property="og:description" content={`${category.name} concerning upcoming celebrities.`} />
